...
\noindent \textbf{Transfer Learning for Covid-19 Detection from ChestX-Ray}
\hfill{Spring 2020}\\
Rutgers University
\begin{itemize}
  \itemsep0em
  \item Adapted transfer learning to analyze the Chest X-ray from suspected cases.  With a tuned vgg-16 model, we had an accuracy of 90\% on average.
\end{itemize}
